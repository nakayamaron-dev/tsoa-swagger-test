...
const user = new usersController_1.UsersController();
// Use body parser to read sent json payloads
exports.app.use(body_parser_1.default.urlencoded({
    extended: true,
}));
exports.app.use(body_parser_1.default.json());
exports.app.get('/users', (_, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const result = yield user.getUser(1);
        res.json(result);
    }
    catch (err) {
        next(err);
